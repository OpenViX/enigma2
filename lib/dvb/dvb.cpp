 ...
 * available. It doesn't fail if it isn't, nor do anything with the result.
 ...
 */
	...
	eDebug("[eDVBUsbAdapter] linking adapter%d/frontend%d to vtuner%d", nr, best_fei, vtunerid);
