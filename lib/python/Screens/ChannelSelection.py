...
# Map the name to lowercase and convert all non-alphanumeric to _.
			tr_name = re.sub(r'[^a-z0-9]', '_', name.lower())
			if self.mode == MODE_TV:
				str = '1:134:1:0:0:0:0:0:0:0:FROM BOUQUET \"alternatives.%s.tv\" ORDER BY bouquet' % tr_name
			else:
				str = '1:134:2:0:0:0:0:0:0:0:FROM BOUQUET \"alternatives.%s.radio\" ORDER BY bouquet' % tr_name
