...
def InitLcd():
	...
	if detected:
		...
		if SystemInfo["VFD_scroll_repeats"] and getDisplayType() not in ('textlcd7segment'):
		...
		if SystemInfo["VFD_scroll_delay"] and getDisplayType() not in ('textlcd7segment'):
			def scroll_delay(el):
		...
		if SystemInfo["VFD_initial_scroll_delay"] and getDisplayType() not in ('textlcd7segment'):
		...
		if SystemInfo["VFD_final_scroll_delay"] and getDisplayType() not in ('textlcd7segment'):
