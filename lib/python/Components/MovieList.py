...
# If so, use it and remove it (it's a one-off).
#
		try:
			sort_method = self.temp_sort
			del self.temp_sort
		except:
			sort_method = self.sort_type
...
#
		...
		elif sort_method == MovieList.SORT_ALPHANUMERIC:
		...
		elif sort_method == MovieList.SORT_ALPHANUMERIC_REVERSE:
		...
		elif sort_method == MovieList.SORT_ALPHANUMERIC_FLAT:
			self.list.sort(key=self.buildAlphaNumericFlatSortKey)
		elif sort_method == MovieList.SORT_ALPHANUMERIC_FLAT_REVERSE:
			self.list.sort(key=self.buildAlphaNumericFlatSortKey, reverse = True)
		elif sort_method == MovieList.SORT_RECORDED:
			self.list = sorted(self.list[:numberOfDirs], key=self.buildBeginTimeSortKey) + sorted(self.list[numberOfDirs:], key=self.buildBeginTimeSortKey)
		elif sort_method == MovieList.SORT_RECORDED_REVERSE:
		...
		elif sort_method == MovieList.SORT_ALPHAREV_DATE_NEWEST_FIRST:
		...
		elif sort_method == MovieList.SORT_LONGEST:
		...
		elif sort_method == MovieList.SORT_SHORTEST:
