...
class AVSwitch:
	...
	elif about.getChipSetString() in ('7241', '7356', '7358', '7362', '73625', '7424', '7425', '7435', '7552'):
	...
	if modes.has_key("Scart") and getBoxType() in ('dm7080','et5x00','et6x00','gbquad','gbx1','gbx3','ixussone','tmnano2t','vusolo4k','vuuno4k','vuultimo4k','mutant51','mutant1500'):
		del modes["Scart"]
