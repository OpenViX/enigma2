...
class AVSwitch:
	...
	if modes.has_key("Scart") and getBoxType() in ('dm7080','et5x00','et6x00','gbquad','gbx1','gbx3','ixussone','sf4008','tmnano2t','vusolo4k','vuuno4k','vuultimo4k','mutant51','mutant1500'):
		del modes["Scart"]
