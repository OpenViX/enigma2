...
from enigma import eDVBDB, eEPGCache, setTunerTypePriorityOrder, setPreferredTuner, setSpinnerOnOff, setEnableTtCachingOnOff, eEnv, Misc_Options, eBackgroundFileEraser, eServiceEvent, eServiceReference
...
def InitUsageConfig():
	config.misc.dummy = ConfigSelection(choices = [("", "")], default = "")
	...
	config.epgselection.graph_primarybouquet = ConfigYesNo(default = True)
