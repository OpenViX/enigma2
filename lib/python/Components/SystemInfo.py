...
SystemInfo["7segment"] = getBoxType() in ('sf8008', 'dinobot4k', 'anadol4k', 'dinobot4kl', 'mediabox4k', 'dinobot4kse', 'dinobot4kplus', 'dinobot4kmini', 'axashis4kcombo', 'axashis4kcomboplus', 'osmini', 'osnino', 'osninoplus', 'osninopro', 'atemio6000', 'atemio6100', 'bwidowx', 'xpeedlx1', 'mutant1100', 'mutant1200', 'mutant1265', 'mutant1500', 'mutant500c', 'mutant530c', 'h3', 'h4', 'h5', 'h6', 'h7', 'formuler3', 'formuler3ip', 'formuler4', 'formuler4ip', 'formuler4turbo', 'spycatmini', 'spycatminiplus', 'xp1000', '9900lx', 'ew7358', 'ew7362', '7220s', '7300s', 'sh1', 'inihde2', 'inihde', 'odinm7', 'jj7362', 'vg2000', 'vg5000', 'vs1000', 'tiviarmin', 'g100', 'g101', 'xc7362', 'et1x000', 'xc7358')
...
SystemInfo["display220"] = getMachineBuild() in ('7100s', '7210s', '7105s', '7215s', '8100s') or getBoxType() in ('gb800ue', 'gbquad', 'gbultraue', 'gbultraueh', 'gbue4k', 'gb800ueplus')
...
SystemInfo["VFD_scroll_repeats"] = getBoxType() not in ('et8500') and fileCheck("/proc/stb/lcd/scroll_repeats") and not SystemInfo["7segment"]
SystemInfo["VFD_scroll_delay"] = getBoxType() not in ('et8500') and fileCheck("/proc/stb/lcd/scroll_delay") and not SystemInfo["7segment"]
SystemInfo["VFD_initial_scroll_delay"] = getBoxType() not in ('et8500') and fileCheck("/proc/stb/lcd/initial_scroll_delay") and not SystemInfo["7segment"]
SystemInfo["VFD_final_scroll_delay"] = getBoxType() not in ('et8500') and fileCheck("/proc/stb/lcd/final_scroll_delay") and not SystemInfo["7segment"]
...
SystemInfo["7segment"] = getBoxType() in ('dinobot4k', 'anadol4k', 'dinobot4kl', 'mediabox4k', 'dinobot4kse', 'dinobot4kplus', 'dinobot4kmini', 'axashis4kcombo', 'axashis4kcomboplus', 'osmini', 'osnino', 'osninoplus', 'osninopro', 'atemio6000', 'atemio6100', 'bwidowx', 'xpeedlx1', 'hd1100', 'hd1200', 'hd1265', 'hd1500', 'hd500c', 'hd530c', 'h3', 'h4', 'h5', 'h6', 'h7', 'formuler3', 'formuler3ip', 'formuler4', 'formuler4ip', 'formuler4turbo', 'spycatmini', 'spycatminiplus', 'xp1000', '9900lx', 'ew7358', 'ew7362', '7220s', '7300s', 'sh1', 'inihde2', 'inihde', 'odinm7', 'jj7362', 'vg2000', 'vg5000', 'vs1000', 'tiviarmin', 'g100', 'g101', 'xc7362', 'et1x000', 'xc7358')
